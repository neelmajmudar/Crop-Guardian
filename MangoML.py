...
model = keras.models.load_model('mango_disease_model81.h5')

# Define a function to predict an image
def predict_image(image_path):
    img = image.load_img(image_path, target_size=(82, 82))
...
# Example usage:
image_path = 'train/Black Mould Rot/aspergillus_001.jpg'
