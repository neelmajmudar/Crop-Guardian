...
# Save the model
model.save('tomatoplant_disease_model.h5')
"""

# Load the pre-trained model
model = keras.models.load_model('tomatoplant_disease_model90.h5')
...
# Example usage:
image_path = 'test/Tomato_Early_blight/00e7c4b2-3005-4558-9cfa-235e356cb7a8___RS_Erly.B 7844.jpg'
